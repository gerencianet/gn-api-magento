...
Além disso, a **data de nascimento** é obrigatória para cobranças via cartão e o **cpf** é obrigatório para qualquer tipo de pagamento. Acesse Sistema > Configuração > Configuração do cliente > Opções de Nome e Endereço e marque "obrigatório" para "Exibir Data de Nascimento" e "Exibir CPF/CNPJ".
